<div>
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-3 text-center">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 mb-4">
            ...
            <tbody>
            @foreach($listaAssociazioniAttivitaClient as $item)
                <tr class="bg-white text-center dark:text-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 flex justify-center">
                        <button
                            ...
                            wire:confirm="Sei sicuro che vuoi eliminare {{$item->client->name}} - {{$item->activity->name}}?"
        ...
        {{ $listaAssociazioniAttivitaClient->links(data: ['scrollTo' => false]) }}
    </div>
